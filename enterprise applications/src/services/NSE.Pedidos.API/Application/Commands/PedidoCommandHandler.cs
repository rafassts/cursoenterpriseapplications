...
namespace NSE.Pedidos.API.Application.Commands
{
        ...
        IRequestHandler<AdicionarPedidoCommand, ValidationResult>
    {
        ...
        //poderia ser uma saga ou um serviço de domínio 
        public async Task<ValidationResult> Handle(AdicionarPedidoCommand message, CancellationToken cancellationToken)
        {
            ...
            // Adicionar Evento - cai no pedidoeventhandler via publicação do mediator em memória
        ...
        private async Task<bool> AplicarVoucher(AdicionarPedidoCommand message, Pedido pedido)
        {
            ...
            //as specs retornam um validationresult
            var voucherValidation = new VoucherValidation().Validate(voucher);
            if (!voucherValidation.IsValid)
            {
                //adiciona erro no validationresult do command
        ...
        public async Task<bool> ProcessarPagamento(Pedido pedido, AdicionarPedidoCommand message)
        {
            var pedidoIniciado = new PedidoIniciadoIntegrationEvent
            {
                ...
                TipoPagamento = 1, // fixo cartão. Alterar se tiver mais tipos
