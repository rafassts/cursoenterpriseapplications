...
namespace NSE.Pagamentos.API.Services
{
    public class PagamentoService : IPagamentoService
    {
        ...
        public async Task<ResponseMessage> CapturarPagamento(Guid pedidoId)
        {
            ...
            var transacaoAutorizada = transacoes?.FirstOrDefault(t => t.Status == StatusTransacao.Autorizado); //pega só a autorizada
            var validationResult = new ValidationResult();

            //tentar capturar sem autorização antes 
