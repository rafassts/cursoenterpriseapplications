...
namespace NSE.Bff.Compras.Controllers
{
    ...
    public class CarrinhoController : MainController
    {
        ...
        //mvc não se comunica direto com o back, mas com o bff
        [HttpGet]
        ...
        //frombody de um campo só - desse jeito podemos receber um dado sem precisar fromquery
        ...
        private async Task ValidarItemCarrinho(ItemProdutoDTO produto, int quantidade, bool adicionarProduto = false)
        {
            ...
            //verifica se a quantidade que já tem no carrinho mais a quantidade adicionada tem em estoque
